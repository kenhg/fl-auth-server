...
var RegisterStrategy = (function (_LocalStrategy) {
  ...
  function RegisterStrategy() {
    ...
    _get(Object.getPrototypeOf(RegisterStrategy.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(RegisterStrategy, [{
    ...
    value: function verify(req, email, password, callback) {
      ...
      User.findOne({ email: email }, function (err, existing_user) {
        ...
        var user = new User(_extends({ email: email, password: User.createHash(password), email_confirmation_token: (0, _lib.createToken)() }, extra_params));
